module deimos.cbor.common;

import deimos.cbor.configuration;
...
extern __gshared const ubyte cbor_major_version;
extern __gshared const ubyte cbor_minor_version;
extern __gshared const ubyte cbor_patch_version;

enum CBOR_VERSION = TO_STR(CBOR_MAJOR_VERSION) ~ "." ~ TO_STR(
            CBOR_MINOR_VERSION) ~ "." ~ TO_STR(CBOR_PATCH_VERSION);
enum CBOR_HEX_VERSION = (CBOR_MAJOR_VERSION << 16) | (CBOR_MINOR_VERSION << 8) | CBOR_PATCH_VERSION;

/* http://stackoverflow.com/questions/1644868/c-define-macro-for-debug-printing
 */

extern (D) string TO_STR_(T)(auto ref T x)
{
    import std.conv : to;
...
alias TO_STR = TO_STR_; /* enables proper double expansion */
...
enum _CBOR_MALLOC = &malloc;
enum _CBOR_REALLOC = &realloc;
enum _CBOR_FREE = &free;
